  ...
  return (
    <html lang="en" className="!scroll-smooth">
      ...
      >
        ...
        <div className="bg-[	#E6E6FA] absolute top-[-1rem] -z-10 left-[-45rem] h-[71.25rem] w-[-30rem] rounded-full blur-[10rem] sm:w-[68.75rem] md:left-[-33rem] lg:left-[-28rem] xl:left-[-15rem] 2xl:left-[-5rem]"></div>
        <Header />
        {children}
      </body>
    </html>
