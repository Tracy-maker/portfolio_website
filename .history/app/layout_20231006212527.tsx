  ...
  return (
    <html lang="en" className="!scroll-smooth">
      ...
      >
        ...
        <div className="bg-[	#E6E6FA] absolute top-[-41rem] -z-10 left-[-145rem] h-[100.25rem] w-[-60rem] rounded-full blur-[10rem] sm:w-[168.75rem] md:left-[-63rem] lg:left-[-98rem] xl:left-[-95rem] 2xl:left-[-95rem]"></div>
        <Header />
        {children}
      </body>
    </html>
