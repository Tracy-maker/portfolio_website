  ...
  return (
    ...
    >
      ...
      <p className="mb-3">
        ...
        and Firebase. 
        <span className="font-medium">
        Currently seeking a full-time position as a software developer or junior front-end developer, I am eager to contribute my refined skills to an innovative organization. 
        </span>
