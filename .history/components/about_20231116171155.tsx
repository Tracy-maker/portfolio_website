  ...
  return (
    ...
    >
      ...
      <p className="mb-3">
        ...
        <span className="font-medium">
        Whether it's uncovering meaningful information behind financial results or identifying areas for enhancement, my goal is to contribute significantly to organizational success.
        </span>
