    ...
    >
      ...
      <p className="mb-3">
        ...
        <span className="italic">
          ...
          information.
        </span>By leveraging my analytical skills, I seek to empower decision-makers with the insights needed for strategic planning and contribute to the overall efficiency and success of the team. 
        <span className="font-medium">
