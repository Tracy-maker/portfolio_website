  ...
  return (
    <section className="mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]">
      ...
      <div>
        ...
        <a className="bg-blue-100 px-7 py-3 flex items-center gap-2 rounded-full">
          <BsLinkedin />
        </a>
        <a className="bg-blue-100 px-7 py-3 flex items-center gap-2 rounded-full text-[1.35rem]">
          <FaGithubSquare />
        </a>
      </div>
    </section>
