  ...
  return (
    <section className="mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]">
      ...
      <div className="flex flex-col sm:flex-row">
        ...
        <a className="bg-purple-100 px-7 py-3 flex items-center gap-2 rounded-full text-[2rem]">
          <BsLinkedin />
        </a>
        <a className="bg-blue-100 px-7 py-3 flex items-center gap-2 rounded-full text-[2rem]">
          <FaGithubSquare />
        </a>
      </div>
    </section>
