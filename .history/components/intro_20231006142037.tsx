    ...
    <section className="mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]">
      ...
      >
        ...
        <a
          ...
          target="_blank"
          className="bg-purple-50 px-7 py-3 flex items-center gap-2 rounded-full text-[2rem] focus:scale-[1.15] hover:scale-110 active:scale-105 transition cursor-pointer border border-black/10"
        >
          <BsLinkedin />
        </a>
        <a
