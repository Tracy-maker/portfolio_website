    ...
    >
      ...
      >
        ...
        <a
          href="/CV.pdf"
          download
          className="group bg-blue-300 px-7 py-3 flex items-center gap-2 rounded-full outline-none focus:scale-110 hover:scale-110 active:scale-105 transition cursor-pointer borderBlack"
        >
          Download CV 🤠
        </a>
        <a
