    ...
    >
      ...
      >
        ...
        <a
          ...
          target="_blank"
          className="bg-purple-500 px-7 py-3 flex items-center gap-2 rounded-full text-[1.6rem] focus:scale-[1.15] hover:scale-[1.15] active:scale-105 transition cursor-pointer border border-black/10"
        >
          <BsLinkedin />
        </a>
      </motion.div>
